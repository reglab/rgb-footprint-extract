...
singularity exec --nv $GROUP_HOME/singularity/rgb-building1.sif python3 run_deeplab.py --minference --backbone=drn_c42 --out-stride=8 \
    ...
    --data-root='/oak/stanford/groups/deho/building_compliance/san_jose_naip_512/2020/superresx2/' \
    --output-dir='/oak/stanford/groups/deho/building_compliance/san_jose_naip_512/2020/infer'
